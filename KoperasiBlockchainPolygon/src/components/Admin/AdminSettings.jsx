        ...
        <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
                ...
                <div style={cardStyle}>
                    ...
                    <div style={{ marginBottom: '16px', background: '#eff6ff', padding: '12px', borderRadius: '8px', borderLeft: '4px solid #2563eb' }}>
                        <div style={{ fontSize: '0.85rem', color: '#64748b', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Saat Ini</div>
                        <div style={{ fontSize: '2rem', fontWeight: '800', color: '#1e40af' }}>
                            {config && config.bunga ? config.bunga : 0}%
                        </div>
                    </div>
                    <form onSubmit={handleUpdateBunga}>
                        <label style={labelStyle}>Update Bunga Bulanan (%)</label>
                ...
                <div style={cardStyle}>
                    ...
                    <div style={{ marginBottom: '16px', background: '#fff7ed', padding: '12px', borderRadius: '8px', borderLeft: '4px solid #ea580c' }}>
                        <div style={{ fontSize: '0.85rem', color: '#9a3412', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Saat Ini</div>
                        <div style={{ fontSize: '2rem', fontWeight: '800', color: '#c2410c' }}>
                            {config && config.denda ? config.denda : 0}‰
                        </div>
                    </div>
                    <form onSubmit={handleUpdateDenda}>
                        <label style={labelStyle}>Update Denda Harian (Permil ‰)</label>
                        <div style={{ display: 'flex', gap: '10px' }}>
                            <input
                                type="number"
                                style={inputStyle}
